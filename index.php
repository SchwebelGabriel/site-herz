  ...
  <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img id="banner-desktop" class="d-none d-md-block w-100" src="/img/banners/banner-site-desktop.jpg" alt="...">
      ...
      <div class="carousel-item">
        ...
        <img id="banner-mobile" class="d-md-none d-block w-100" src="/img/banners/banner-site-mobile-2.jpg" alt="...">
      </div>
    </div>
